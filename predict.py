...
def combine_predictions(result_logistic_regression):
    if result_logistic_regression == 1:
        return "Normal"
    else:
        return "Anomaly"
...
def predict(values):
    ...
    final_result = combine_predictions(result_logistic_regression)
    return final_result
